...
const COMMENT_TYPE_LABELS: Record<CommentType, { label: string; color: string }> = {
  suggestion: { label: 'Suggestion', color: 'bg-amber-100 dark:bg-yellow-900/30 text-amber-800 dark:text-amber-300' },
  question: { label: 'Question', color: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300' },
  feedback: { label: 'Feedback', color: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' },
  answer: { label: 'Answer', color: 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300' },
};
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{comment.author_name}</span>
                ...
                return (
                  <div
                    ...
                    className={`border-l-2 pl-3 py-2 rounded-lg ${
                      isAI
                        ? 'border-purple-300 dark:border-purple-700 bg-gradient-to-r from-purple-50 dark:from-purple-900/30 to-blue-50 dark:to-blue-900/30'
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-sm font-medium ${isAI ? 'text-purple-700 dark:text-purple-300' : 'text-gray-700 dark:text-gray-300'}`}>
                        {reply.author_name}
                      </span>
                      ...
                      {isAI && (
                        <span className="text-xs px-1.5 py-0.5 rounded bg-purple-200 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300">
                          Auto-generated
                        </span>
                      )}
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 space-y-3">
              {replyTo && (
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 dark:text-gray-400">Replying to comment</span>
                  <button
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                <select
                  value={commentType}
                  onChange={(e) => setCommentType(e.target.value as CommentType)}
                  className="px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
                >
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
              />

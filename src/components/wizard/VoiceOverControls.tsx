      ...
      <div className="px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-1.5 hover:bg-white/60 dark:hover:bg-gray-700/60 rounded-lg transition-colors"
            ...
            {currentSpeaker && (
              <div className="flex items-center gap-2 px-3 py-1 bg-white/60 dark:bg-gray-700/60 rounded-full">
                <div
                  className={`w-2 h-2 rounded-full animate-pulse ${
                    isPlaying && !isPaused ? 'bg-red-500' : 'bg-gray-400 dark:bg-gray-500'
                  }`}
                />
            ...
            {isExpanded && (
              <>
                ...
                <button
                  ...
                  className="p-2 hover:bg-white/60 dark:hover:bg-gray-700/60 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors ${
                    showVoiceSettings ? 'bg-indigo-600 text-white' : 'hover:bg-white/60 dark:hover:bg-gray-700/60 text-indigo-600 dark:text-indigo-400'
                  }`}
        ...
        {showVoiceSettings && isExpanded && (
          <div className="mt-3 pt-3 border-t border-indigo-200 dark:border-indigo-800 space-y-3">
            {/* TTS Provider Toggle */}
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-gray-300 block mb-1.5">TTS Engine</label>
              <div className="flex gap-2">
                ...
                >
                  <div className="text-center">
                    <div>Browser TTS</div>
                    <div className={`text-xs mt-0.5 ${ttsProvider === 'browser' ? 'text-indigo-200' : 'text-gray-500 dark:text-gray-400'}`}>
                ...
                >
                  <div className="text-center">
                    <div>Kokoro AI</div>
                    <div className={`text-xs mt-0.5 ${ttsProvider === 'kokoro' ? 'text-emerald-200' : 'text-gray-500 dark:text-gray-400'}`}>
                      Natural speech, ~92MB
                    </div>
                  </div>
                </button>
              ...
              {ttsProvider === 'kokoro' && !modelReady && !modelLoading && (
                <button
                  onClick={onLoadModel}
                  className="mt-2 w-full px-3 py-1.5 text-xs font-medium bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-lg hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-colors"
                >
                  Download Model
                </button>
              )}
            ...
            {ttsProvider === 'kokoro' && (
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-gray-700 dark:text-gray-300 block mb-1">Interviewer Voice</label>
                  <select
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-700 dark:text-gray-300 block mb-1">Candidate Voice</label>
                  <select
